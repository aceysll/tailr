    ...
    const groqRes = await fetch("https://api.groq.com/openai/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are an expert CV writer. Return ONLY valid JSON with this structure: {"jobTitle":"","company":"","tailoredCv":"full rewritten CV as plain text","coverLetter":"full cover letter 3-4 paragraphs"}. Keep actual job titles and dates. Rewrite bullets to match the job. No invented experience. No placeholder text in cover letter.`,
          },
          {
            role: "user",
            content: `CV:\n${trimmedCv}\n\nJob Description:\n${trimmedJob}`,
